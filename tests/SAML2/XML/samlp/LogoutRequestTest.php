...
XML;
    ...
    public function testSetSessionIndicesVariants(): void
    {
        ...
        $this->assertEquals('SessionIndexValue1', $logoutRequest->getSessionIndexes()[0]->getValue());
        $this->assertEquals('SessionIndexValue2', $logoutRequest->getSessionIndexes()[1]->getValue());
    }
}
